...
public class Event_NewMainBuildingRiskHypothesesDetermined extends InternalEvent {

	private AssessRequest theRequest;
	private AssessRequestReply theReply;
	private Case  theCase;

	public Event_NewMainBuildingRiskHypothesesDetermined() {

		super();

		this.setEventTypeCategory(InternalEvent.t_internalEventTypeCategory.ImpactfullEnvironmentalMutation);
		this.eventType = InternalEvent.t_internalEventType.Build_NewMainBuildingRiskHypothesesDetermined;
